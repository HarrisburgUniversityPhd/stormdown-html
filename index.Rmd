...
url: 'https\://github.com/HarrisburgUniversityPhd/stormdown-lite'
github-repo: HarrisburgUniversityPhd/stormdown-lite
editor_options:
...
```
```{r child = here('dissertation/research-umbrella.Rmd')}
```
```{r child = here('dissertation/prior-art.Rmd')}
```
